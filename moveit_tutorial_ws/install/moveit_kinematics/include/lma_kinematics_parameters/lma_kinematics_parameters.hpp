...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    : ParamListener(parameters_interface, rclcpp::get_logger("lma_kinematics"), prefix) {
    ...
    private:
      ...
      rclcpp::Logger logger_ = rclcpp::get_logger("lma_kinematics");
